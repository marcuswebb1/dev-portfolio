...
const Resume = () => (
    <>
        ...
        <div className="container my-3">
            <div class="box-card mx-auto d-flex flex-column justify-content-between">
                <div class="card-upper bg-dark text-center py-3 btr-7">
                    <h2><span class="text-white font-weight-bold">Resume</span></h2>
                </div>

                {/* <!--  Education Div  --> */}
                <div class="education-div bg-light p-4 mb-1">
                    <header class="div-headers d-flex justify-content-between">
                        <h3 class="text-dark">Education</h3>
                        <a class="btn btn-outline-dark collapser-btn" data-toggle="collapse" href="#collapseExample-1" role="button" aria-expanded="false" aria-controls="collapseExample-1">View More</a>
                    </header>
                    
                    <div class="collapse collapse-example-1 py-3" id="collapseExample-1">
                        <div class="d-flex justify-content-center">
                            <div class="card-body text-dark">
                                <h5><span class="text-info">Team Treehouse</span> - </h5>
                                <p><span class="font-weight-bold">Degree:</span> Completed the Front End Web Development Track</p>
                                <h5><span class="text-info">John Tyler Community College</span> - </h5>
                                <p><span class="font-weight-bold">Degree:</span> A.S. in Computer Science</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* <!--  Work History Div  --> */}
                <div class="work-history-div bg-light p-4">
                    <header class="div-headers d-flex justify-content-between">
                        <h3 class="text-dark work-history">Work History</h3>  
                        {/* <!-- collapser --> */}
                        <a class="btn btn-outline-dark collapser-btn" data-toggle="collapse" href="#collapseExample-2" role="button" aria-expanded="false" aria-controls="collapseExample-2">View More</a>
                    </header>
                
                    <div class="collapse py-3" id="collapseExample-2">
                        <div class="card-lower">
                            <div class="card cards text-dark bg-light mb-3">
                                <div class="card-header text-info">Public Consulting Group</div>
                                <div class="card-body">
                                    <h5 class="card-title text-dark">IT Implementation Specialist (March 2020 - <span class="text-info">April 2020</span>)</h5>
                                    <ul class="box-card-text box-text-sm">
                            ...
                            <div class="card cards text-dark bg-light mb-3">
                                <div class="card-header text-info">CarMax</div>
                                <div class="card-body">
                                <h5 class="card-title text-dark">IT Systems Analyst (October 2019 - February 2020)</h5>
                                    <ul class="box-card-text box-text-sm">
                            ...
                            <div class="card cards text-dark bg-light mb-3">
                                <div class="card-header text-info">Core Technologies Inc.</div>
                                <div class="card-body">
                                <h5 class="card-title text-dark">PC Refresh Technician (June 2017 - December 2019)</h5>
                                    <ul class="box-card-text box-text-sm">
                            ...
                            <div class="card cards text-dark bg-light mb-3">
                                <div class="card-header text-info">Core Technologies Inc.</div>
                                <div class="card-body">
                                <h5 class="card-title text-dark">IT Support Specialist (September 2016 - June 2017)</h5>
                                    <ul class="box-card-text box-text-sm">
                            ...
                            <div class="card cards text-dark bg-light mb-3">
                                <div class="card-header text-info">Technology Integration Group</div>
                                <div class="card-body">
                                <h5 class="card-title text-dark">PC Bench Technician (March 2014 – September 2016)</h5>
                                    <ul class="box-card-text box-text-sm">
                            ...
                            <div class="card cards text-dark bg-light mb-3">
                                <div class="card-header text-info">NAPA Auto Parts</div>
                                <div class="card-body">
                                <h5 class="card-title text-dark">Delivery Driver (April 2013 – March 2014)</h5>
                                    <ul class="box-card-text box-text-sm">
                            ...
                            <div class="card cards text-dark bg-light mb-3">
                                <div class="card-header text-info">Office Max</div>
                                <div class="card-body">
                                <h5 class="card-title text-dark">Technical Support Specialist (March 2011 - April 2013)</h5>
                                    <ul class="box-card-text box-text-sm">
                ...
                <div className="bg-light p-3 mt-1 bbr-7 d-flex justify-content-center justify-content-lg-start">
                    <a href={ResumeFile} download class="btn btn-outline-info my-3 d-block">Download Resume</a>
                </div>
                
            </div>
            {/* <footer class="resume-footer">2019 &copy; Marcus Webb</footer> */}
        </div>
    </>
)
